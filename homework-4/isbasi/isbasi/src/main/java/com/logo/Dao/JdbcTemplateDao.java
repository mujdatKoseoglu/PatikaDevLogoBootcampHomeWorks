...
public class JdbcTemplateDao implements AddressDaoImp{
    @Autowired
    private AddressJpaRepository addressJpaRepository;

    public JdbcTemplateDao(AddressJpaRepository addressJpaRepository) {
        this.addressJpaRepository = addressJpaRepository;
    }
    //ekleme
    public Address add(Address address){
        System.out.println("Jdbc Template'den addres ekleniliyor : " + address.getAddress());
